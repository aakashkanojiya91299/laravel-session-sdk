...
│   ├── LaravelSessionClient.ts   # Main SDK class
│   │
│   ├── types/
│   │   └── index.ts              # TypeScript type definitions
│   │
│   ├── decoders/
│   │   ├── PhpSerializer.ts      # PHP serialization handler
│   │   └── SessionDecoder.ts     # Session payload decoder
│   │
│   ├── stores/
│   │   ├── StoreInterface.ts     # Store interface definition
│   │   ├── DatabaseStore.ts      # MySQL/PostgreSQL store
│   │   └── RedisStore.ts         # Redis store
│   │
│   ├── validators/
